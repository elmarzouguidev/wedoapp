    ...
    <div class="custom-container">
        ...
        <div class="sticky-news d-flex card-h">
            <div class="news-img-box">
                <img src="{{asset('assets/imgs/news-1.jpg') }}" alt="News" />
            </div>
            <div class="news-content">
                <h5 class="section-subtitle">MOBILE DEVELOPMENT</h5>
                <h1 class="section-title">OpenAI launches new alignment division to tackle risks of superintelligent AI
                </h1>
                <p>The makers of AI have announced the company will be dedicating 20% of its compute processing power
        ...
        <div class="news-items align-items-start">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-2.jpg') }}" alt="News" />
                </div>
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-3.jpg') }}" alt="News" />
                </div>
                <div class="news-item-body">
                    <h5 class="section-subtitle">WEB DEVELOPMENT</h5>
                    <h1 class="section-title">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-4.jpg') }}" alt="News" />
                </div>
                <div class="news-item-body">
                    <h5 class="section-subtitle">WEB DEVELOPMENT</h5>
                    <h1 class="section-title">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-5.jpg') }}" alt="News" />
                </div>
                <div class="news-item-body">
                    <h5 class="section-subtitle">WEB DEVELOPMENT</h5>
                    <h1 class="section-title">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-6.jpg') }}" alt="News" />
                </div>
                <div class="news-item-body">
                    <h5 class="section-subtitle">WEB DEVELOPMENT</h5>
                    <h1 class="section-title">
            ...
            <div class="news-item card-h">
                <div class="news-img-box">
                    <img src="{{asset('assets/imgs/news-7.jpg') }}" alt="News" />
                </div>
                <div class="news-item-body">
                    <h5 class="section-subtitle">WEB DEVELOPMENT</h5>
                    <h1 class="section-title">
                    ...
                    <p>OpenAI is reportedly under additional legal scrutiny, as the US Federal Trade Commission asks the
                        company to give detailed explanations</p>
                    <ul>
                        <li>
                            <i class="las la-check"></i> Collaboration Tools
                        </li>
