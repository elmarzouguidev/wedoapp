<section class="how-we-do-area">
    <div class="custom-container">
        <div class="custom-row">
            <img src="{{ asset('assets/imgs/bg-shape-1.svg') }}" alt="Shape"
            ...
            <div class="how-we-do-right-content">
                <div class="how-we-do-items d-flex align-items-center justify-content-center">
                    ...
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-1.svg') }}" alt="How we do" />
                        </div>
                    ...
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-2.svg') }}" alt="How we do" />
                        </div>
                        <div class="how-we-do-content">
                            <h4>Product</h4>
                            <p>Design</p>
                    ...
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-3.svg') }}" alt="How we do" />
                        </div>
                        <div class="how-we-do-content">
                            <h4>Front-End</h4>
                            <p>Development</p>
                ...
                <div class="how-we-do-items d-flex align-items-center justify-content-center">
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-4.svg') }}" alt="How we do" />
                        </div>
                        <div class="how-we-do-content">
                            <h4>SEO</h4>
                            <p>Optimization</p>
                    ...
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-5.svg') }}" alt="How we do" />
                        </div>
                        <div class="how-we-do-content">
                            <h4>Back-End</h4>
                            <p>Development</p>
                ...
                <div class="how-we-do-items d-flex align-items-center justify-content-center">
                    ...
                    <div class="how-we-do-card">
                        ...
                        <div class="how-we-do-icon">
                            <img src="{{ asset('assets/imgs/hwd-icon-6.svg') }}" alt="How we do" />
                        </div>
                        <div class="how-we-do-content">
                            <h4>Digital</h4>
                            <p>Marketing</p>
