                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            <img class="animation-slide-right bg-shape" src="{{ asset('assets/imgs/bg-shape-3.svg') }}"
                                alt="Shape" />
                            <span class="platform-name">
                                <img src="{{ asset('assets/imgs/icon-linkedin.svg') }}" alt="Icon" />
                            </span>
                    ...
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            <img class="bg-shape" src="{{ asset('assets/imgs/bg-shape-3.svg') }}" alt="Shape" />
                            <span class="platform-name">
                                <img src="{{ asset('assets/imgs/icon-linkedin.svg') }}" alt="Icon" />
                            </span>
                            ...
                            <p>One aspect that sets IT Services apart is their proactive approach to security.
                                ...
                                importance.</p>
                            <div class="author-box d-flex align-items-center">
                                <img src="{{ asset('assets/imgs/testimonial-2.jpeg') }}" alt="Testimonial" />
                                <div class="author-box-content">
                                    <h4>Megan Clarke</h4>
                                    <p>CEO, Sanlab</p>
                                </div>
                    ...
                    <div class="swiper-slide testimonial-item">
                        <div class="testimonial-item-body">
                            ...
                            <p>One aspect that sets IT Services apart is their proactive approach to security.
                                ...
                                importance.</p>
                            <div class="author-box d-flex align-items-center">
                                <img src="{{ asset('assets/imgs/testimonial-3.jpeg') }}" alt="Testimonial" />
                                <div class="author-box-content">
                                    <h4>Rachel Olsem</h4>
